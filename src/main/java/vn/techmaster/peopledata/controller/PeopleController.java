...
/*  //2.9 Tuổi trung bình từng nghề nghiệp
  ...
  @GetMapping("GroupDeveloperByCity")
  public ResponseEntity<Map<String, List<Person>>> groupDeveloperByCity() {
    return ResponseEntity.ok().body(personRepo.groupDeveloperByCity());
  }
  @GetMapping("maleFemaleRatio")
  ...
  @GetMapping("youngestDeveloperCity")
  public ResponseEntity<List<Map.Entry<String,Double>>> youngestDeveloperCity() {

    return ResponseEntity.ok().body(personRepo.youngestDeveloperCity());
    //youngestDeveloperCity
  }
}
